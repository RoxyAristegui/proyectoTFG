              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4 IniciarSesion"> Iniciar Sesión</h1>
                  </div>
                  ...
                  <div class="text-center">
                    <a class="small NuevoCrearCuenta" href="../Controller/Register_Controller.php">Eres nuevo? Crea una cuenta </a>
                  </div>
                </div>
              </div>
            </div>
