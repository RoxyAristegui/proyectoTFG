    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item">
        <a class="nav-link" href="../Controller/PROVEEDORES_Controller.php" aria-expanded="true" aria-controls="collapseUsuarios">
          <i class="fas fa-fw fa-user"></i>
        ...
        <div id="collapsePermisos" class="collapse" aria-labelledby="" data-parent="#accordionSidebar" style="">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item GestionRoles" href='../Controller/ROLES_Controller.php?action=ADD'> Gestion de roles</a>  <a class="collapse-item AsociarUsuariosRol" href='../Controller/ROLES_Controller.php?action=EDIT'> Asociar usuarios a Rol</a>
