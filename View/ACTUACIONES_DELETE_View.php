...
class ACTUACIONES_DELETE{
    ...
    function render(){
		...
		?>
        <div class="container">
            <h1 class="EliminarActuacion">Eliminar actuacion</h1>
            <form name = 'Form' action='../Controller/ACTUACIONES_Controller.php' method='post' ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows='4' name='descripcion' class="form-control" id='nombre'  placeholder='' readonly> <?php echo $this->tupla['descripcion'] ?> </textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type='date' name='fecha_actuacion' id ='fecha_actuacion' class="form-control" placeholder=''  value="<?php echo $this->tupla['fecha_actuacion'] ?>"   readonly>
                            </div>
                        </div>
                    </div>

                        <button type='submit' name='action' class="btn btn-outline-info delete icon" value="DELETE" id="confirm" ></button>
